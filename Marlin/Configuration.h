...
#define STRING_CONFIG_H_AUTHOR "(vale, BIQU-B1)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 22.8750
    #define DEFAULT_Ki 1.6346
    #define DEFAULT_Kd 80.0282
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 86.2806
  #define DEFAULT_bedKi 10.9458
  #define DEFAULT_bedKd 453.4045
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1, -30, -0.7 }
